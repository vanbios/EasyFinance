...
public class FloatingActionMenu extends ViewGroup {
    ...
    private void createMenuButton() {
        ...
        mImageToggle.setMaxWidth(mIconSize);
        mImageToggle.setMaxHeight(mIconSize);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        int imageLeft = buttonsHorizontalCenter - mIconSize / 2;
        int imageTop = menuButtonTop + mMenuButton.getMeasuredHeight() / 2 - mIconSize / 2;

        mImageToggle.layout(imageLeft, imageTop, imageLeft + mIconSize,
                imageTop + mIconSize);
